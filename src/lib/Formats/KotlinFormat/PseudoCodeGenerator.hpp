...
#ifndef Whip_Formats_KotlinFormat_PseudoCodeGenerator_hpp
#define Whip_Formats_KotlinFormat_PseudoCodeGenerator_hpp
...
namespace Whip::KotlinFormat {
    /// A pseudo code generator for the kotlin language.
    /// Generates kotlin code that represents the pseudo code by traversing the expression tree.
